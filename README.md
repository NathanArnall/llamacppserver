...
llama.cpp should be built in the home directory (~) of your user, built in a "build" directory.

Models should be stored in the home directory/models (/models) of your user (or modify the for f in ~/models/* line).
